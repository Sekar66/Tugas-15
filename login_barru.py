...
class TestLogin(unittest.TestCase):  # TEST SCENARIO
    ...
    def test_d_failed_login_with_invalid_email(self): 
        ...
        browser.get("http://barru.pythonanywhere.com/daftar") # buka situs
        time.sleep(3)
        browser.find_element(By.XPATH,"/html/body/div/div[2]/form/input[1]").send_keys("zaza@gmail") # isi email
        time.sleep(1)
        browser.find_element(By.CSS_SELECTOR,"input#password").send_keys("zazazizi") # isi password
        time.sleep(1)
        browser.find_element(By.ID,"signin_login").click() # klik tombol sign in
    ...
    def test_e_failed_login_with_max_character(self): 
        ...
        browser.find_element(By.XPATH,"/html/body/div/div[2]/form/input[1]").send_keys("zaza@gmail") # isi email
        time.sleep(1)
        browser.find_element(By.CSS_SELECTOR,"input#password").send_keys("zazazizizazazizizazazizizazazizi") # isi password
        time.sleep(1)
        browser.find_element(By.ID,"signin_login").click() # klik tombol sign in
        time.sleep(1)
